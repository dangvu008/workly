...
// Function to generate sample notes with current timestamps
...
// Function to add sample notes to storage
export const addSampleNotesToStorage = async () => {
  ...
  try {
    ...
    if (existingNotes.length === 0) {
      ...
      console.log('✅ Added sample notes to storage');
      return sampleNotes;
    } else {
